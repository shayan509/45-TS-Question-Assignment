...
let current_users: string[] = ['Shayan', 'Haseeb', 'Nabeel', 'Atif', 'Ali'];

// Define the list of new users
let new_users: string[] = ['SHAYAN', 'atif', 'ali', 'sarib', 'abdullah'];
...
let favoritePizzas: string[] = ['Pepperoni', 'Cheese', 'Fajita'];
